...
class AppStateNotifier extends ChangeNotifier {
  VisionTEKFirebaseUser? initialUser;
  VisionTEKFirebaseUser? user;
  ...
  void update(VisionTEKFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              ...
              path: 'homePageWesiteSupport',
              builder: (context, params) => params.isEmpty
                  ? NavBarPage(initialPage: 'HomePageWesiteSupport')
                  : HomePageWesiteSupportWidget(),
            ),
            FFRoute(
              name: 'profilePage',
              path: 'profilePage',
